...
| <a name="input_ecr_repository_name"></a> [ecr\_repository\_name](#input\_ecr\_repository\_name) | Name of the ECR repository | `list(string)` | <pre>[<br/>  "movie-rating",<br/>  "movie-rating-migrations",<br/>  "movie-rating-helm-chart"<br/>]</pre> | no |
